...
const updateAgentValidation = {
  body: Joi.object({
    ...
    phone: Joi.string().trim().allow(null, '').optional().max(14),
      ...
      .items(
        Joi.object()
          .keys({
            ...
            payPermission: Joi.boolean().optional(),
          })
          .required()
      )
      .required(),
      ...
      .items(
        Joi.object()
          .keys({
            ...
            payPermission: Joi.boolean().optional().messages({
              'any.required': `"permission payPermission" is a required field`,
            }),
            action: Joi.string()
              .trim()
