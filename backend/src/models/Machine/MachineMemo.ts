...
export class MachineMemo extends Model<MachineMemo> {
  ...
  @Column({ type: DataTypes.STRING, allowNull: true, field: 'invoice_id' }) // for credit and Tax memo
  invoiceId: string;
  ...
  @Column({ type: DataTypes.JSONB, field: 'gst_percentage', allowNull: true })
  gstPercentage: {};
  ...
  @Column({
    type: DataTypes.DECIMAL(10, 2),
    field: 'topup_amount_adjusted',
    defaultValue: 0,
  })
  topupAmountAdjusted: number;
  ...
  @Column({
    type: DataTypes.DECIMAL(10, 2),
    field: 'credit_remaining_balance',
    defaultValue: 0,
  })
  ...
  @Column({ type: DataTypes.JSONB, field: 'memoDetail', allowNull: true })
  memoDetail: {};
  ...
  blueverseCredit: DataTypes.DecimalDataType;

  @Column({ type: DataTypes.JSONB, field: 'blueverse_debit', allowNull: true })
  blueverseDebit: {};
