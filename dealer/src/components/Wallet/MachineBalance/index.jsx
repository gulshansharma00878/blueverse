...
import SearchBar from "components/utitlities-components/Search"
...
import { exportHistoryData } from "pages/private/dealer/Wallet/walletutilities"
...
function MachineTransactionHistory() {
  ...
  const getMachines = async () => {
    ...
    const machineList = getMachines?.filter((item) => {
      return item?.value == params?.machineId
    })
      ...
      <Grid container>
        ...
        <Grid sx={styles.walletBox} item md={6} xs={12}>
          <MachineCards
            ...
            handleToggle={() =>
              navigate(`/${user?.role}/wallet/wallet-balance-history/${params?.machineId}`)
            }
        ...
        <Grid sx={styles.creditBox} item md={6} xs={12}>
          <MachineCards
            ...
            handleText="View History"
            handleToggle={() =>
              navigate(`/${user?.role}/wallet/credit-balance-history/${params?.machineId}`)
            }
