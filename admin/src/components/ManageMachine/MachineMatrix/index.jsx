...
function MachineMatrix({ waterQualityData, waterConsumptionData, machineId }) {
  ...
  const waterUsedData = [
    {
      title: "Chemical Used",
      naviagte: `/${user?.role}/manage-machines/details/chemical-performance/${machineId}`,
    ...
    },
    {
      ...
      naviagte: `/${user?.role}/manage-machines/details/electricity-consumption/${machineId}`,
    ...
    {
      title: "Washes",
      naviagte: `/${user?.role}/manage-machines/details/water-washes/${machineId}`,
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
          <Box className={styles.matrix_box}>
            {BoxTitileComponent(
              "Water Quality",
              `/${user?.role}/manage-machines/details/water-quality/${machineId}`
            )}
        ...
        <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
          <Box className={styles.matrix_box}>
            {BoxTitileComponent(
              "Water Consumption",
              `/${user?.role}/manage-machines/details/water-consumption/${machineId}`
            )}
              ...
              <Box className={styles.matrix_box}>
                ...
                <Box className={styles.matrix_inner_box}>
                  <Box
                    ...
                    sx={{ background: theme.palette.background.gray2 }}>
                    <Box>
                  ...
                  <Box
                    className={styles.matrix_inner_row}
                    sx={{ background: theme.palette.background.pink3 }}>
                    <Box>
