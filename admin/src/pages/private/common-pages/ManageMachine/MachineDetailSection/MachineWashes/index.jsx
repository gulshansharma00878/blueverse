...
import MachineWashesCard from "components/utilities-components/MachinesWashesCard"
  ...
  let ans = [
    [
      ...
      },
      {
        key: "Silver Washes",
        value: data?.[0]?.count,
        bgColor: theme?.palette?.background?.gray2
      },
      {
        key: "Gold Washes",
        value: data?.[2]?.count,
        bgColor: theme?.palette?.background?.pink3
      },
      {
        key: "Platinum Washes",
        value: data?.[1]?.count,
